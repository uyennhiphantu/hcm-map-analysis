...
def make_map(A, B, coords14, coords25, meta_text: str, out_path: str):
    ...
    # 2018 solid
    folium.PolyLine(coords14, weight=5, opacity=0.85, tooltip="Route 2018").add_to(m)
    # 2025 dashed
